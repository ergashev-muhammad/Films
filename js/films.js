var films = [
  ...
  },
  {
    ...
    overview:
      "Once upon a time there was a big green giant named Shrek in a fairy-tale state. He lived in proud solitude in the forest, in the swamp, which he considered his own. But one day, the evil shorty - Lord Farquad, the ruler of the magical kingdom, mercilessly drove all the fairy-tale inhabitants to the Shrekov swamp. And the carefree life of the green troll came to an end. But Lord Farquaad promised to return the swamp to Shrek if the giant gets him the beautiful princess Fiona, who languishes in an impregnable tower guarded by a fire-breathing dragon.",
    release_date: 1540342800,
  ...
  },
  {
    ...
    poster: "https://image.tmdb.org/t/p/w500/bHzz0i6Ue7IixhSjFlGs0slzL2m.jpg",
    overview:
      "The time of prosperity is coming to an end, and the summer, which lasted almost a decade, is fading away. Around the center of power of the Seven Kingdoms, the Iron Throne, a conspiracy is brewing, and in this difficult time, the king decides to seek support from a friend of his youth, Eddard Stark. In a world where everyone - from the king to the mercenary - strives for power, weaves intrigues and is ready to stick a knife in the back, there is a place for nobility, compassion and love. Meanwhile, no one notices the awakening of darkness from the legends far in the North - and only the Wall protects the living to the south of it.",
    release_date: 1540342800,
  ...
  },
  {
    id: "424694",
    title: "Forset Gump",
    poster: "https://image.tmdb.org/t/p/w500/oTiRsQCIHJPUR7wA1chpTf8j9go.jpg",
    overview:
      "On behalf of the protagonist Forrest Gump, a weak-minded harmless person with a noble and open heart, the story of his extraordinary life is told. In a fantastic way, he turns into a famous football player, war hero, and successful businessman. He becomes a billionaire, but remains the same ingenuous, stupid and kind. Forrest is waiting for constant success in everything, and he loves the girl with whom he was friends in childhood, but reciprocity comes too late.",
    release_date: 1540342800,
    genres: ["Comedy", "Drama"],
  },
];
